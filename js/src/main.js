...
jQuery(document).ready(function($){
	...
	$( 'body a:not(.previous):not(.next):not(.lightbox-iframe)' ).click(function( e ){
		...
		if ( the_link.hasClass( 'bypass' ) ||
			...
			if ( confirm( "You are leaving our website and linking to an alternate website not operated by us. Educational Community Alliance Credit Union does not endorse or guarantee the products, information, or recommendations provided by third-party vendors or third-party linked sites." ) ) {
