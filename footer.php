...
?>	
	...
	<div class="colophon">
		...
		<div class="column links">
			...
			<a href="https://www.instagram.com/educacreditunion/" class="alignright"><img src="<?php bloginfo( 'template_url' ); ?>/img/icon-insta.png" class="alignright" alt="Visit us on Facebook."></a>
			<a href="https://www.facebook.com/EducaCommunity/" class="alignright"><img src="<?php bloginfo( 'template_url' ); ?>/img/icon-facebook.png" class="alignright" alt="Visit us on Facebook."></a>
